...
import 'package:object_detection_flutter/ui/box_widget.dart';
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        (stats.inferenceTime ==0 && stats.preProcessingTime == 0 && stats.totalElapsedTime == 0 && stats.totalPredictTime == 0)
                            ? Padding(
...
class StatsRow extends StatelessWidget {
  ...
  StatsRow(this.left, this.right, {super.key});
